...
class GridEncoder(nn.Module):
    def __init__(
        ...
        self.num_levels = num_levels  # num levels, each level multiply resolution by 2 - L
        self.level_dim = level_dim  # encode channels per level - F
        self.per_level_scale = (
            per_level_scale  # multiply resolution by this scale at each level. - b growth factor
        )
